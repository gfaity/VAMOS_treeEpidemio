...
myDevices = rev(sort(unique(data$Device)))
...
whichWay = 2 #1 = manual, #2 = automatic (all or selected permutations)
...
if (whichWay==1){
  ...
  variable_order = c("Position", "Device", "EpochDuration", "DropTime", "BoutDuration", "StudyID")
